      ...
      <div className="not-prose flex items-center gap-3">
        <div className="flex size-6 shrink-0 items-center justify-center">
          {experience.companyLogo ? (
            ...
            <span className="flex size-2 rounded-full bg-zinc-100 dark:bg-zinc-100" />
          )}
        </div>
      ...
      <div className="relative last:before:absolute last:before:h-full last:before:w-4 last:before:bg-background">
        <CollapsibleTrigger
          className={cn(
            ...
            "relative before:absolute before:-top-1 before:-right-1 before:-bottom-1.5 before:left-7 before:rounded-lg hover:before:bg-muted/0 cursor-pointer",
          ...
          <div className="relative z-1 flex items-center gap-2 pl-9 text-sm text-muted-foreground">
            ...
            <dl>
              ...
              <dd className="flex items-center gap-0.5 tabular-nums">
                ...
                {isOngoing ? (
                  <Infinity className="size-4.5 translate-y-[0.5px]" aria-label="Present" />
                ) : (
                  <span>{end}</span>
                )}
              </dd>
...
function Skill({ className, ...props }: ComponentProps<"span">) {
  return (
    <span
      className={cn(
        "inline-flex items-center rounded-md border bg-muted/20 px-1.5 py-0.5 font-mono text-xs text-muted-foreground",
        className
      )}
      {...props}
    />
